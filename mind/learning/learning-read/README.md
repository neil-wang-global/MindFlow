...
- `mind/learning/reviews/` — optionally scan for recent `same-context` rejections to detect human review escalation triggers per `reviews/TEMPLATE.md §Human Review Escalation`
